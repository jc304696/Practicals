...
from Lab08.Practicals2016_master.Prac08.programming_language import ProgrammingLanguage
...
def main():
    ...
    print('\nDo you want to add another programing language? Y)es / N)o')
    choice = str(input('>>> ')).upper()

    while choice != 'N':
        # gather language information from user
        name = str(input('Language name: '))
        typing = str(input('Typing style: '))
        reflection = str(input('Is it a Reflection (True/False): '))
        year = int(input('Year developed: '))
